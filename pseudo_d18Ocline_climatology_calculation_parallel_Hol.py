...
Climatology-template version of pseudo_d18Ocline_pymc_calculation_parallel_Hol.py.
...
thermocline that the parametric function cannot. Results are saved as separate
netCDF inference files (new output dirs) so the erf-based outputs are untouched.
"""
...
# filter for more than 3 species
d18O_pd_grouped = d18O_pd_grouped[d18O_pd_grouped>=3].dropna()
